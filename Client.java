				...
				if (chatMessages[k] != null) {
					...
					if (l == 6 && splitPrivateChat == 0 && privateChatMode < 2) {
						if (i1 > 0 && i1 < 110) {
							...
							textDrawingArea.method385(0x800000, chatMessages[k], i1,
...
//	notifyItemSpawn(item, i + baseX, j + baseY);
	...
	private void method26(boolean flag) {
		for (int j = 0; j < npcCount; j++) {
			NonPlayingCharacter npc = npcArray[npcIndices[j]];
	...
	private void processChatModeClick() {
		if (super.clickMode3 == 1) {
			if (super.saveClickX >= 6 && super.saveClickX <= 106 && super.saveClickY >= 467
			...
			if (super.saveClickX >= 135 && super.saveClickX <= 235 && super.saveClickY >= 467
					&& super.saveClickY <= 499) {
			...
			if (super.saveClickX >= 273 && super.saveClickX <= 373 && super.saveClickY >= 467
					&& super.saveClickY <= 499) {
			...
			if (super.saveClickX >= 412 && super.saveClickX <= 512 && super.saveClickY >= 467
					&& super.saveClickY <= 499)
		...
		try {
			...
			for (int j = -1; j < playerCount + npcCount; j++) {
				...
				if (obj instanceof NonPlayingCharacter) {
					EntityDef entityDef = ((NonPlayingCharacter) obj).desc;
				...
				if (j < playerCount) {
					...
					EntityDef entityDef_1 = ((NonPlayingCharacter) obj).desc;
				...
				for (int j1 = 0; j1 < 4; j1++)
					if (((Entity) (obj)).hitsLoopCycle[j1] > loopCycle) {
						...
						if (spriteDrawX > -1) {
							...
							aTextDrawingArea_1270.drawText(0, String.valueOf(((Entity) (obj)).hitArray[j1]),
									spriteDrawY + 4, spriteDrawX);
							aTextDrawingArea_1270.drawText(0xffffff, String.valueOf(((Entity) (obj)).hitArray[j1]),
	...
	private void method38() {
		...
		for (int k = 0; k < npcCount; k++) {
			int l = npcIndices[k];
			NonPlayingCharacter npc = npcArray[l];
	...
	private void method46(int i, Stream stream) {
		while (stream.bitPosition + 21 < i * 8) {
			...
			if (k == 16383)
				break;
			if (npcArray[k] == null)
				npcArray[k] = new NonPlayingCharacter();
			NonPlayingCharacter npc = npcArray[k];
		...
		for (Animable_Sub4 class30_sub2_sub4_sub4 = (Animable_Sub4) aClass19_1013
			...
			if (class30_sub2_sub4_sub4.anInt1597 != plane || loopCycle > class30_sub2_sub4_sub4.anInt1572)
				...
				if (class30_sub2_sub4_sub4.anInt1590 > 0) {
					NonPlayingCharacter npc = npcArray[class30_sub2_sub4_sub4.anInt1590 - 1];
	...
	private void doAction(int i) {
		...
		if (l >= 2000)
			l -= 2000;
		if (l == 582) {
			NonPlayingCharacter npc = npcArray[i1];
			if (npc != null) {
		...
		if (l == 20) {
			NonPlayingCharacter class30_sub2_sub4_sub1_sub1_1 = npcArray[i1];
		...
		if (l == 225) {
			NonPlayingCharacter class30_sub2_sub4_sub1_sub1_2 = npcArray[i1];
		...
		if (l == 965) {
			NonPlayingCharacter class30_sub2_sub4_sub1_sub1_3 = npcArray[i1];
		...
		if (l == 413) {
			NonPlayingCharacter class30_sub2_sub4_sub1_sub1_4 = npcArray[i1];
		...
		if (l == 200)
			clearTopInterfaces();
		if (l == 1025) {
			NonPlayingCharacter class30_sub2_sub4_sub1_sub1_5 = npcArray[i1];
		...
		if (l == 412) {
			NonPlayingCharacter class30_sub2_sub4_sub1_sub1_6 = npcArray[i1];
		...
		if (l == 478) {
			NonPlayingCharacter class30_sub2_sub4_sub1_sub1_7 = npcArray[i1];
	...
	private void build3dScreenMenu() {
		...
		for (int k = 0; k < Model.anInt1687; k++) {
			...
			if (k1 == 1) {
				NonPlayingCharacter npc = npcArray[l1];
				if (npc.desc.aByte68 == 1 && (npc.x & 0x7f) == 64 && (npc.y & 0x7f) == 64) {
					for (int j2 = 0; j2 < npcCount; j2++) {
						NonPlayingCharacter npc2 = npcArray[npcIndices[j2]];
			...
			if (k1 == 0) {
				...
				if ((player.x & 0x7f) == 64 && (player.y & 0x7f) == 64) {
					for (int k2 = 0; k2 < npcCount; k2++) {
						NonPlayingCharacter class30_sub2_sub4_sub1_sub1_2 = npcArray[npcIndices[k2]];
				...
				if (class19 != null) {
					for (Item item = (Item) class19.getFirst(); item != null; item = (Item) class19.getNext()) {
						...
						if (itemSelected == 1) {
							...
							menuActionName[menuActionRow] = "Examine @lre@" + itemDef.name + " @gre@(@whi@" + item.ID
									+ "@gre@)";
	...
	private void processRightClick() {
		...
		if (super.mouseX > 553 && super.mouseY > 205 && super.mouseX < 743 && super.mouseY < 466)
			if (invOverlayInterfaceID != -1)
				buildInterfaceMenu(553, RSInterface.interfaceCache[invOverlayInterfaceID], super.mouseX, 205,
						super.mouseY, 0);
			else if (tabInterfaceIDs[tabID] != -1)
				buildInterfaceMenu(553, RSInterface.interfaceCache[tabInterfaceIDs[tabID]], super.mouseX, 205,
						super.mouseY, 0);
...
//	entityMessage(npc);
	...
	void startUp() {
		...
		try {
			...
			TextDrawingArea aclass30_sub2_sub1_sub4s[] = { aTextDrawingArea_1270, aTextDrawingArea_1271,
	...
	private void method100(Entity entity) {
		...
		if (entity.interactingEntity != -1 && entity.interactingEntity < 32768) {
			NonPlayingCharacter npc = npcArray[entity.interactingEntity];
			if (npc != null) {
								...
								if (k5 > DrawingArea.topX - 32 && k5 < DrawingArea.bottomX && j6 > DrawingArea.topY - 32
									...
									if (class30_sub2_sub1_sub1_2 != null) {
										...
										if (class30_sub2_sub1_sub1_2.anInt1444 == 33
											...
											aTextDrawingArea_1270.method385(0, intToKOrMil(k10), j6 + 10 + j7,
													k5 + 1 + k6);
											aTextDrawingArea_1270.method385(0xffff00, intToKOrMil(k10), j6 + 9 + j7,
													k5 + k6);
										}
									}
								}
	...
	private void drawMinimap() {
		...
		for (int i6 = 0; i6 < npcCount; i6++) {
			NonPlayingCharacter npc = npcArray[npcIndices[i6]];
		...
		if (anInt855 != 0 && loopCycle % 20 < 10) {
			if (anInt855 == 1 && anInt1222 >= 0 && anInt1222 < npcArray.length) {
				NonPlayingCharacter class30_sub2_sub4_sub1_sub1_1 = npcArray[anInt1222];
				if (class30_sub2_sub4_sub1_sub1_1 != null) {
...
//aryan	entity.entScreenX = spriteDrawX; entity.entScreenY = spriteDrawY;
	...
	private void method139(Stream stream) {
		...
		for (int i1 = 0; i1 < k; i1++) {
			...
			NonPlayingCharacter npc = npcArray[j1];
			int k1 = stream.readBits(1);
			if (k1 == 0) {
		...
		try {
			...
			if (pktType == 73 || pktType == 241) {
				...
				for (int j24 = 0; j24 < 16384; j24++) {
					NonPlayingCharacter npc = npcArray[j24];
					if (npc != null) {
...
//            }
	...
	private Client() {
		...
		npcArray = new NonPlayingCharacter[16384];
	...
	private NonPlayingCharacter[] npcArray;
