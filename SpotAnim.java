public final class SpotAnim {
	...
	protected final int anInt400;
	public static SpotAnim cache[];
	protected int anInt404;
	protected int anInt405;
	protected int anInt406;
	public Animation aAnimation_407;
	protected final int[] anIntArray408;
	protected final int[] anIntArray409;
	public int anInt410;
	public int anInt411;
	public int anInt412;
	public int anInt413;
